...
type IProps = { node: IDicePoolSumNode };

export const DicePoolSumDetails: React.FunctionComponent<IProps> = ({ node }) => {
      ...
      <div className="flex flex-col px-2">
        ...
        <div className="w-full flex items-center justify-between border-b py-2">
          ...
          <input
            type="text"
            id="min"
            className="bg-gray-100 py-1 px-2 border shadow-none focus:ring-1 outline-none text-center w-32"
            value={name}
            onChange={(e) => {
